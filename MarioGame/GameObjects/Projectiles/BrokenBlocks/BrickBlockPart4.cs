...
{
    class BrickBlockPart4 : Fireball, IProjectile
    {

        public BrickBlockPart4(Vector2 positionOnScreen, ShootAngle angle) : base(positionOnScreen, angle)
        {
            bounceBound = 3;
        }

        public BrickBlockPart4() : this(new Vector2(0), ShootAngle.Right)
        {
