...
{
    class BrickBlockPart3 : Fireball, IProjectile
    {

        public BrickBlockPart3(Vector2 positionOnScreen, ShootAngle angle) : base(positionOnScreen, angle)
        {
            bounceBound = 3;
        }

        public BrickBlockPart3() : this(new Vector2(0), ShootAngle.Right)
        {
