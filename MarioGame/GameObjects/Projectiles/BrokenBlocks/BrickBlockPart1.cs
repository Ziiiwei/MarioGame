...
{
    class BrickBlockPart1 : Fireball, IProjectile
    {

        public BrickBlockPart1(Vector2 positionOnScreen, ShootAngle angle) : base(positionOnScreen, angle)
        {
            bounceBound = 3;
        }

        public BrickBlockPart1() : this(new Vector2(0), ShootAngle.Right)
        {
