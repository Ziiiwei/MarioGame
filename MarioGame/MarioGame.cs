    ...
    public class MarioGame : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            ArenaPaths = new Dictionary<int, Tuple<string, string>>()
            {
                ...
                {2, new Tuple<string, string>("Arena Two", "MarioGame/Data/DataFiles/level2a.csv") },
                {3, new Tuple<string, string>("Arena Three", "MarioGame/Data/DataFiles/level3.csv") },
                {4, new Tuple<string, string>("Flat Level", "MarioGame/Data/DataFiles/flatlevel.csv") }
            };
